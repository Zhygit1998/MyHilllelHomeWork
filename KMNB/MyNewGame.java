...
public class MyNewGame {
    ...
    public static String[] playM() {
        ...
        System.out.println("Введите совое имя");
        String name = scanner.nextLine();
        System.out.println("Введите колличесвто партий");
       ...
       String[] strRes = new String[countRound];
        ...
        for (int i = 0; i < countRound; i++) {
           ...
           countPC = (int) (Math.random() * 2);
            ...
            String[][] str = {{"Ничья", "PC", name}, {name, "Ничья", "PC"}, {"PC", name, "Ничья"}};
            String strCount = str[countUs][countPC];
